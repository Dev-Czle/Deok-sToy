...
//
//import com.example.androidbaseuiunittest.calculator.CalculatorLegacy
...
//    private val calculator = CalculatorLegacy()
//
...
//        val inOrder = Mockito.inOrder(calculatorMockData)
//        // 기대값 1
...
//        verify(calculatorMockData,Mockito.atLeastOnce()).firstNumber
//        verify(asdacalculatorMockData,Mockito.atLeastOnce()).secondNumber
//
...
//        calculator.doCalculate(calculatorMockData)
//        verify(calculatorMockData,Mockito.atLeastOnce()).firstNumber
//        verify(calculatorMockData,Mockito.atLeastOnce()).secondNumber
//
//        // 각 계산된 값과 기대값이 일치하는지 확인
//        assertTrue(calculator.getAddResult() == expectedAdded)
//        assertTrue(calculator.getSubtractResult() == expectedSubtract)
